...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.jvkj9eh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.put('/user', async (req, res) => {
   ...
   res.send(result)
      ...
      app.get('/rooms', async (req, res) => {
         ...
         let query = {}
         if (category && category !== 'null') query = {
            category
         }
